...
const MyTeam = () => {
    ...
    const stats = [
        { label: 'Total Members', value: TEAM_MEMBERS.length, icon: Users, color: 'text-blue-600', bg: 'bg-blue-50 dark:bg-blue-900/20' },
                ...
                <AnimatePresence mode="popLayout">
                    {filteredMembers.map((member) => (
                        ...
                        >
                            ...
                            {/* Recent Activity Mini Indicator */}
                            <div className="mt-6 pt-6 border-t border-slate-50 dark:border-slate-800 w-full text-center">
                                <span className="text-[10px] uppercase tracking-widest font-black text-slate-400 dark:text-slate-600">
                                    Active 2h ago
                                </span>
                            </div>
                        </motion.div>
